      ...
      <main className="relative z-10 flex-1 flex items-center justify-center p-4 sm:p-6 lg:p-8">
        <div className="max-w-6xl w-full grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          ...
          >
            ...
            {/* Quick Role-based Demo Access Bar */}
            <div className="bg-slate-900/60 border border-slate-800/80 rounded-3xl p-4 sm:p-5 backdrop-blur-md space-y-3">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  <Layers className="w-4 h-4 text-blue-400" />
                  <h3 className="text-xs font-bold text-slate-200 uppercase tracking-wide">
                    សាកល្បងចូលតាមតួនាទី (Quick Role Demo)
                  </h3>
                </div>
                <span className="text-[11px] text-slate-400">ចុច ១ ឃ្លីកដើម្បីសាកល្បង</span>
              </div>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-5 gap-2">
                ...
                <button
                  ...
                  className="p-2.5 rounded-2xl bg-blue-950/60 hover:bg-blue-900/80 border border-blue-800/70 text-blue-100 flex flex-col items-center gap-1.5 transition-all group hover:scale-[1.03] cursor-pointer shadow-sm"
                >
                  <div className="w-8 h-8 rounded-xl bg-blue-600 text-white flex items-center justify-center shadow-md">
                    <Building2 className="w-4 h-4" />
                  </div>
                  <span className="text-[11px] font-bold text-center">នាយកសាលា</span>
                  <span className="text-[9px] text-blue-300 text-center truncate w-full">លីម សន</span>
                </button>
                ...
                <button
                  ...
                  className="p-2.5 rounded-2xl bg-indigo-950/60 hover:bg-indigo-900/80 border border-indigo-800/70 text-indigo-100 flex flex-col items-center gap-1.5 transition-all group hover:scale-[1.03] cursor-pointer shadow-sm"
                >
                  <div className="w-8 h-8 rounded-xl bg-indigo-600 text-white flex items-center justify-center shadow-md">
                    <ShieldCheck className="w-4 h-4" />
                  </div>
                  <span className="text-[11px] font-bold text-center">លេខាធិការ</span>
                  <span className="text-[9px] text-indigo-300 text-center truncate w-full">ម៉ៅ សុខា</span>
                </button>
                ...
                <button
                  ...
                  className="p-2.5 rounded-2xl bg-amber-950/60 hover:bg-amber-900/80 border border-amber-800/70 text-amber-100 flex flex-col items-center gap-1.5 transition-all group hover:scale-[1.03] cursor-pointer shadow-sm"
                >
                  <div className="w-8 h-8 rounded-xl bg-amber-600 text-white flex items-center justify-center shadow-md">
                    <BookOpen className="w-4 h-4" />
                  </div>
                  <span className="text-[11px] font-bold text-center">បណ្ណារក្ស</span>
                  <span className="text-[9px] text-amber-300 text-center truncate w-full">គឹម សុជាតិ</span>
                </button>
                ...
                <button
                  ...
                  className="p-2.5 rounded-2xl bg-emerald-950/60 hover:bg-emerald-900/80 border border-emerald-800/70 text-emerald-100 flex flex-col items-center gap-1.5 transition-all group hover:scale-[1.03] cursor-pointer shadow-sm"
                >
                  <div className="w-8 h-8 rounded-xl bg-emerald-600 text-white flex items-center justify-center shadow-md">
                    <User className="w-4 h-4" />
                  </div>
                  <span className="text-[11px] font-bold text-center">គ្រូបង្រៀន</span>
                  <span className="text-[9px] text-emerald-300 text-center truncate w-full">ចាន់ វុទ្ធី (៦ក)</span>
                </button>
                ...
                <button
                  ...
                  className="p-2.5 rounded-2xl bg-purple-950/60 hover:bg-purple-900/80 border border-purple-800/70 text-purple-100 flex flex-col items-center gap-1.5 transition-all group hover:scale-[1.03] cursor-pointer shadow-sm col-span-2 sm:col-span-1"
                >
                  <div className="w-8 h-8 rounded-xl bg-purple-600 text-white flex items-center justify-center shadow-md">
                    <GraduationCap className="w-4 h-4" />
                  </div>
                  <span className="text-[11px] font-bold text-center">សិស្សានុសិស្ស</span>
                  <span className="text-[9px] text-purple-300 text-center truncate w-full">សុខ តារា (៦ក)</span>
                </button>
              </div>
            </div>
          </motion.div>
