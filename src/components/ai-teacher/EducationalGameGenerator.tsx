...
export const EducationalGameGenerator: React.FC<Props> = ({ initialGame, onSaved }) => {
  ...
  // Game templates list (10 rich templates)
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-2xl border border-slate-200 p-6 shadow-xs space-y-6">
        <div className="border-b border-slate-100 pb-4">
          <h3 className="text-lg font-bold font-moul text-blue-950 flex items-center gap-2">
            ...
            <span>បង្កើតល្បែងសិក្សាឌីជីថលក្នុងថ្នាក់រៀន (Interactive Classroom Games)</span>
          </h3>
          <p className="text-xs text-slate-500 mt-1">
            ផ្លាស់ប្តូរបរិយាកាសថ្នាក់រៀនឱ្យកាន់តែរីករាយ និងសកម្ម តាមរយៈល្បែងសិក្សា ១០ ទម្រង់ដែលបង្កើតដោយ AI ស្របតាមមេរៀន។
          </p>
        </div>

        {/* 10 Game Templates Selection Grid */}
        <div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 border-t border-slate-100 pt-4">
          ...
          <div className="sm:col-span-2 lg:col-span-4">
            ...
            <input
              ...
              placeholder="ឧ. ចំនួនប្រភាគ, វដ្តនៃទឹក, ប្រវត្តិប្រាសាទអង្គរវត្ត..."
              className="w-full px-3.5 py-2.5 rounded-xl border border-slate-200 bg-slate-50 text-sm focus:bg-white focus:ring-2 focus:ring-blue-800 outline-hidden font-medium"
            />
          </div>
        </div>
      ...
      {game && (
        <div className="bg-white rounded-2xl border border-slate-200 p-6 shadow-xs space-y-6">
          ...
          <div className="border-b border-slate-200 pb-4 flex flex-col md:flex-row md:items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-2 flex-wrap">
              ...
              <button
                ...
                className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-blue-900 to-indigo-900 hover:from-blue-800 hover:to-indigo-800 text-white rounded-xl text-xs font-bold transition-all shadow-xs"
              >
          ...
          {/* 1. LIVE SINGLE PLAYER PREVIEW STAGE */}
          {isPlaying && (
              ...
              {isGameOver ? (
                <div className="text-center py-10 space-y-4 max-w-md mx-auto">
                  ...
                  <div className="flex items-center justify-center gap-3 pt-4">
                    <button
                      onClick={startPlaying}
                      className="px-5 py-2.5 bg-emerald-500 hover:bg-emerald-600 rounded-xl font-bold text-xs flex items-center gap-2 transition-all"
                    >
                      <RotateCcw className="w-4 h-4" /> លេងម្តងទៀត
                    </button>
                    <button
                      onClick={() => setIsPlaying(false)}
                      className="px-5 py-2.5 bg-white/20 hover:bg-white/30 rounded-xl font-bold text-xs transition-all"
                    >
                      ចាកចេញ
                    </button>
                  </div>
          ...
          {/* 2. QUESTION CARDS LIST OVERVIEW */}
          {!isPlaying && (
