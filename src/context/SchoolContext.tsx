...
export const SchoolProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const dispatchNotification = (...args: any[]) => {};
  ...
  const markNotificationRead = (...args: any[]) => {};

  const markAllNotificationsRead = (...args: any[]) => {};

  const clearNotification = (...args: any[]) => {};

  const clearAllNotifications = (...args: any[]) => {};

  const syncRealSchoolNotifications = (...args: any[]) => {};
